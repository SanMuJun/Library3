 ...
 */
public class ListViewLibraryFragmentInformationAdapter extends BaseAdapter {
    ...
    private final List<BookBean.Book.Information> information;

    public ListViewLibraryFragmentInformationAdapter(
            Context context,
        ...
        information = bookListData.get(0).getInformation();
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.tv_book_name.setText("书名："+information.get(i).bookName);
        viewHolder.tv_book_author.setText("作者："+information.get(i).bookAuthor);
        viewHolder.tv_book_publish.setText("出版社："+information.get(i).bookPulish);
        viewHolder.tv_book_publicationtime.setText("出版时间："+information.get(i).bookPublicationTime);

        x.image().bind(viewHolder.iv_book_image,information.get(i).bookImageUrl);
        ...
        viewHolder.bt_listview_borrowlend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(context, "借阅： "+information.get(i).bookName+"  成功", Toast.LENGTH_SHORT).show();

                BorrowAndReadInfo borrowAndReadInfo = new BorrowAndReadInfo(i, information.get(i).getBookName(), information.get(i).getBookAuthor(),
                        information.get(i).getBookImageUrl(), null, null, null);
        ...
        viewHolder.bt_listview_collection.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                CollectionInfo collectionInfo = new CollectionInfo(-1,
                        information.get(i).getBookName(),
                        information.get(i).getBookAuthor(),
                        information.get(i).getBookFloor(),
                        information.get(i).getBookImageUrl());
                collectionTableDAO.insertCollectionTable(collectionInfo);

                Toast.makeText(context, "收藏： "+information.get(i).bookName+"  成功", Toast.LENGTH_SHORT).show();
