 ...
 */
public class ListViewLibraryFragmentOtherAdapter extends BaseAdapter {
    ...
    private final List<BookBean.Book.Other> other;


    public ListViewLibraryFragmentOtherAdapter(
            Context context,
        ...
        other = bookListData.get(7).Other;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.tv_book_name.setText("书名："+other.get(i).bookName);
        viewHolder.tv_book_author.setText("作者："+other.get(i).bookAuthor);
        viewHolder.tv_book_publish.setText("出版社："+other.get(i).bookPulish);
        viewHolder.tv_book_publicationtime.setText("出版时间："+other.get(i).bookPublicationTime);

        x.image().bind(viewHolder.iv_book_image,other.get(i).bookImageUrl);
        ...
        viewHolder.bt_listview_borrowlend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(context, "借阅： "+other.get(i).bookName+"  成功", Toast.LENGTH_SHORT).show();

                BorrowAndReadInfo borrowAndReadInfo = new BorrowAndReadInfo(i, other.get(i).getBookName(), other.get(i).getBookAuthor(),
                        other.get(i).getBookImageUrl(), null, null, null);
        ...
        viewHolder.bt_listview_collection.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                CollectionInfo collectionInfo = new CollectionInfo(-1,
                        other.get(i).getBookName(),
                        other.get(i).getBookAuthor(),
                        other.get(i).getBookFloor(),
                        other.get(i).getBookImageUrl());
                collectionTableDAO.insertCollectionTable(collectionInfo);

                Toast.makeText(context, "收藏： "+other.get(i).bookName+"  成功", Toast.LENGTH_SHORT).show();
