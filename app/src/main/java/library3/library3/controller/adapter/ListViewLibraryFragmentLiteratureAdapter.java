 ...
 * 生活图书列表
 */
public class ListViewLibraryFragmentLiteratureAdapter extends BaseAdapter {
    ...
    private final List<BookBean.Book.Literature> literature;

    public ListViewLibraryFragmentLiteratureAdapter(
            Context context,
        ...
        literature = bookListData.get(3).Literature;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.tv_book_name.setText("书名："+literature.get(i).bookName);
        viewHolder.tv_book_author.setText("作者："+literature.get(i).bookAuthor);
        viewHolder.tv_book_publish.setText("出版社："+literature.get(i).bookPulish);
        viewHolder.tv_book_publicationtime.setText("出版时间："+literature.get(i).bookPublicationTime);

        x.image().bind(viewHolder.iv_book_image,literature.get(i).bookImageUrl);
        ...
        viewHolder.bt_listview_borrowlend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(context, "借阅： "+literature.get(i).bookName+"  成功", Toast.LENGTH_SHORT).show();

                BorrowAndReadInfo borrowAndReadInfo = new BorrowAndReadInfo(i, literature.get(i).getBookName(), literature.get(i).getBookAuthor(),
                        literature.get(i).getBookImageUrl(), null, null, null);
        ...
        viewHolder.bt_listview_collection.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                CollectionInfo collectionInfo = new CollectionInfo(-1,
                        literature.get(i).getBookName(),
                        literature.get(i).getBookAuthor(),
                        literature.get(i).getBookFloor(),
                        literature.get(i).getBookImageUrl());
                collectionTableDAO.insertCollectionTable(collectionInfo);

                Toast.makeText(context, "收藏： "+literature.get(i).bookName+"  成功", Toast.LENGTH_SHORT).show();
