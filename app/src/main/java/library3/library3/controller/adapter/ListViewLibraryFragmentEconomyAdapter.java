 ...
 * 生活图书列表
 */
public class ListViewLibraryFragmentEconomyAdapter extends BaseAdapter {
    ...
    private final List<BookBean.Book.Economy> economy;


    public ListViewLibraryFragmentEconomyAdapter(
            Context context,
        ...
        economy = bookListData.get(6).Economy;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.tv_book_name.setText("书名："+economy.get(i).bookName);
        viewHolder.tv_book_author.setText("作者："+economy.get(i).bookAuthor);
        viewHolder.tv_book_publish.setText("出版社："+economy.get(i).bookPulish);
        viewHolder.tv_book_publicationtime.setText("出版时间："+economy.get(i).bookPublicationTime);

        x.image().bind(viewHolder.iv_book_image,economy.get(i).bookImageUrl);
        ...
        viewHolder.bt_listview_borrowlend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(context, "借阅： "+economy.get(i).bookName+"  成功", Toast.LENGTH_SHORT).show();

                BorrowAndReadInfo borrowAndReadInfo = new BorrowAndReadInfo(i, economy.get(i).getBookName(), economy.get(i).getBookAuthor(),
                        economy.get(i).getBookImageUrl(), null, null, null);
        ...
        viewHolder.bt_listview_collection.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                CollectionInfo collectionInfo = new CollectionInfo(-1,
                        economy.get(i).getBookName(),
                        economy.get(i).getBookAuthor(),
                        economy.get(i).getBookFloor(),
                        economy.get(i).getBookImageUrl());
                collectionTableDAO.insertCollectionTable(collectionInfo);

                Toast.makeText(context, "收藏： "+economy.get(i).bookName+"  成功", Toast.LENGTH_SHORT).show();
