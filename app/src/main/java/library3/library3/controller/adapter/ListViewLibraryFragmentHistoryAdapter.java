 ...
 * 生活图书列表
 */
public class ListViewLibraryFragmentHistoryAdapter extends BaseAdapter {
    ...
    private final List<BookBean.Book.History> history;


    public ListViewLibraryFragmentHistoryAdapter(
            Context context,
        ...
        history = bookListData.get(4).History;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.tv_book_name.setText("书名："+history.get(i).bookName);
        viewHolder.tv_book_author.setText("作者："+history.get(i).bookAuthor);
        viewHolder.tv_book_publish.setText("出版社："+history.get(i).bookPulish);
        viewHolder.tv_book_publicationtime.setText("出版时间："+history.get(i).bookPublicationTime);

        x.image().bind(viewHolder.iv_book_image,history.get(i).bookImageUrl);
        ...
        viewHolder.bt_listview_borrowlend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(context, "借阅： "+history.get(i).bookName+"  成功", Toast.LENGTH_SHORT).show();

                BorrowAndReadInfo borrowAndReadInfo = new BorrowAndReadInfo(i, history.get(i).getBookName(), history.get(i).getBookAuthor(),
                        history.get(i).getBookImageUrl(), null, null, null);
        ...
        viewHolder.bt_listview_collection.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                CollectionInfo collectionInfo = new CollectionInfo(-1,
                        history.get(i).getBookName(),
                        history.get(i).getBookAuthor(),
                        history.get(i).getBookFloor(),
                        history.get(i).getBookImageUrl());
                collectionTableDAO.insertCollectionTable(collectionInfo);

                Toast.makeText(context, "收藏： "+history.get(i).bookName+"  成功", Toast.LENGTH_SHORT).show();
